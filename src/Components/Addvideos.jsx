...
import { uploadVideo } from '../server/allApis';
...
function Addvideos() {
    ...
    const handleUpload=async()=>{
      ...
      if(!caption ||!url||!image){
        toast.warning("enter valid detials")
      }
      else{
        // console.log(video)
  ...
  return (
    ...
    <Modal
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        ...
        <Form.Control type="text" name="url"  onChange={(e)=>{getdata(e)}}  placeholder="Enter Video URL" />
      </Form.Group>
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
